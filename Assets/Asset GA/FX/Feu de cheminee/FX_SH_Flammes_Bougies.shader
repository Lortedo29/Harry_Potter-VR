...
Shader "HarryPotter/FX_SH_Feu_Cheminee"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode1 = tex2D( _FlammeTexture, ( ( 30.0 * ( ( tex2D( _PerlinNoise, uv_TexCoord2 ) * tex2D( _VoronoiNoise, uv_TexCoord14 ) * tex2D( _PerlinNoise, uv_TexCoord64 ) ) + ( tex2D( _VoronoiNoise, uv_TexCoord71 ) * float4( 0.1226415,0.1226415,0.1226415,0 ) ) ) * tex2D( _FlammeTexture, uv_FlammeTexture ).a * ( i.uv_texcoord.y * 0.5 ) ) + float4( i.uv_texcoord, 0.0 , 0.0 ) ).rg );
...
/*ASEBEGIN
Version=15401
0.8;23.2;2046;1088;1126.299;311.5496;1;True;False
...
Node;AmplifyShaderEditor.SimpleAddOpNode;68;-1326.261,-676.3643;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-1387.976,-268.8742;Float;False;Constant;_PuissanceDeformation;Puissance Deformation;6;0;Create;True;0;0;False;0;30;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-325.7763,252.522;Float;True;Property;_FlammeTexture;Flamme Texture;1;0;Create;True;0;0;False;0;c7b3ad7925347ca49b492c021997986c;608ccff9f3b0fad4f86b638389e8f01e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B7676817E1B81AF5C6E6B0638D1EE02733F97BA2