...
public static class IntExtension
{
    ...
    //
    public static void DrawCircleInside(this int[,] array, int centerX, int centerY, int radius, int fulfillValue)
    {
        int d = (5 - radius * 4) / 4;
        int x = 0;
        int y = radius;
    ...
    private static void DrawLine(this int[,] array, int x0, int y0, int x1, int y1, int fulfillValue)
    {
